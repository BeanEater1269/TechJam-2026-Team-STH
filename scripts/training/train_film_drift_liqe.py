"""
Same as train_film_normalize_drift.py (DCPT + FiLMClassifier, 4 z-scored B-signals +
...
Usage:
    python scripts/training/train_film_drift_liqe.py
    python scripts/training/train_film_drift_liqe.py --epochs 10 --backbone-dim 768
"""
import argparse
import random
import sys
...
def load_merged_split(
    ...
    train_film_normalize_drift.py's load_merged_split().
...
def main() -> None:
    ...
    ap.add_argument("--out", default="checkpoints/model_film_drift_liqe_normalized.pt")
